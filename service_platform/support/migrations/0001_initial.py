...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ("bookings", "0002_booking_photos_and_notes"),
    ]
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("booking", models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name="support_tickets", to="bookings.servicebooking")),
            ...
            options={
                "ordering": ["-created_at"],
                "indexes": [models.Index(fields=["status", "created_at"], name="support_sup_status_c695e7_idx")],
            },
        )
    ]
